...
let promise = new Promise(function(resolve, reject) {
  request('http://p2p-ekb.xyz:9338/rate', (err, response, rate) => {
  if(err)
    console.log(err);
    statistic.rate = rate
    return rate
  ...
  request('http://p2p-ekb.xyz:9338/difficulty', (err, response, difficulty) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/users', (err, response, users) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/user_stales', (err, response, user_stales) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/fee', (err, response, fee) => {
  if(err)
    console.log(err);
    statistic.fee = fee
    //console.log(response);
  ...
  request('http://p2p-ekb.xyz:9338/current_payouts', (err, response, current_payouts) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/global_stats', (err, response, global_stats) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/local_stats', (err, response, local_stats) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/peer_addresses', (err, response, peer_addresses) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/pings', (err, response, pings) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/recent_blocks', (err, response, recent_blocks) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/web/currency_info', (err, response, currency_info) => {///////
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/local_hash_rate/last_hour', (err, response, local_hash_rate_last_hour) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/web/graph_data/pool_rates/last_hour', (err, response, pool_rates_last_hour) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/web/graph_data/miner_hash_rates/last_hour', (err, response, miner_hash_rates_last_hour) => {
  if(err)
    console.log(err);
  ...
  request('http://p2p-ekb.xyz:9338/web/graph_data/current_payouts/last_hour', (err, response, current_payouts_last_hour) => {
  if(err)
    console.log(err);
  ...
  function call(coin) {
    ...
    //   console.log(err,{port:coin.port});
      ...
      //   // console.log(err,{port:coin.port});
        ...
        //   // console.log(err,{port:coin.port});
          coin.fee = fee
          request('http://p2p-ekb.xyz:'+coin.port+'/global_stats', (err, response, global_stats) => {
          // if(err)
          //   // console.log(err,{port:coin.port});
